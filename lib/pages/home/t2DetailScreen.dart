...
class T2DetailScreen extends StatefulWidget {
  const T2DetailScreen({super.key});

  @override
  State<T2DetailScreen> createState() => _T2DetailScreenState();
}

double _gaugeValue = 40;
double _sliderValue = 10;

class _T2DetailScreenState extends State<T2DetailScreen> {
  @override
