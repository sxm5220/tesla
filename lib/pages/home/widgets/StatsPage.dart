...
import 'LineChartChargeHistory.dart';
...
class _StatsPageState extends State<StatsPage> {
  ...
  Color colorSW1Active = AppColors.kPrimaryColor,
      colorSW1Thumb = Colors.white,
      colorSW1Track = Colors.white;
  Color colorSW2Active = AppColors.kPrimaryColor,
      colorSW2Thumb = AppColors.kPrimaryColor,
      colorSW2Track = Colors.white;
  Color colorSW3Active = AppColors.kPrimaryColor,
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: const BoxDecoration(gradient: AppColors.kBackGroundGradient),
      ...
      child: Column(
        ...
        children: [
          Row(mainAxisAlignment: MainAxisAlignment.start, children: [
            const Icon(Icons.lock_rounded, color: AppColors.kPrimaryColor),
            const SizedBox(width: 7),
            const Text('Doors Locked', style: TextStyle(color: Colors.grey)),
            const Spacer(),
            CupertinoSwitch(
                ...
                onChanged: (value) {
                  stateSW1 = value;
                  if (!stateSW1) {
                    colorSW1Active = AppColors.kPrimaryColor;
                    colorSW1Thumb = AppColors.kPrimaryColor;
                    colorSW1Track = Colors.white;
                  } else {
                    colorSW1Active = AppColors.kPrimaryColor;
                    colorSW1Thumb = Colors.white;
          ...
          Row(mainAxisAlignment: MainAxisAlignment.start, children: [
            const Icon(Icons.cable, color: AppColors.kPrimaryColor),
            const SizedBox(width: 7),
            const Text('Dog Mode', style: TextStyle(color: Colors.grey)),
            const Spacer(),
            CupertinoSwitch(
                ...
                onChanged: (value) {
                  stateSW2 = value;
                  if (!stateSW2) {
                    colorSW2Active = AppColors.kPrimaryColor;
                    colorSW2Thumb = AppColors.kPrimaryColor;
                    colorSW2Track = Colors.white;
                  } else {
                    colorSW2Active = AppColors.kPrimaryColor;
          ...
          Row(
            ...
            children: [
              ...
              const SizedBox(width: 7),
              const Text('Sentry Mode', style: TextStyle(color: Colors.grey)),
              const Spacer(),
              CupertinoSwitch(
                  ...
                  onChanged: (value) {
                    stateSW3 = value;
                    if (!stateSW3) {
                      colorSW3Active = AppColors.kPrimaryColor;
                      colorSW3Thumb = AppColors.kPrimaryColor;
                      colorSW3Track = Colors.white;
                    } else {
                      colorSW3Active = AppColors.kPrimaryColor;
                      colorSW3Thumb = Colors.white;
...
class ACCtrl extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      padding: const EdgeInsets.only(left: 2, right: 2, bottom: 3, top: 1),
      child:
